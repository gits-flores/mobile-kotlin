...
class CardSlider(private val offscreenPageLimit: Int) : ViewPager2.PageTransformer{
    ...
    override fun transformPage(page: View, position: Float) {
        ...
        page.apply {
            ...
            val scaleFactor = -SCALE_FACTOR * position * DEFAULT_ALPHA
            ...
            when{
                ...
                position <= offscreenPageLimit - 1 -> {
                    translationX = scaleFactor
                    scaleX = scaleFactor
                    scaleY = -(width / DEFAULT_TRANSLATION_FACTOR) * position
                    alpha = alphaFactor
                }
